...
function markFinderPattern(x, y, moduleSize,context) 
{
...
function markQRCodeArea(location, version, context) 
{
        context.lineWidth = 2;
        ...
        markFinderPattern(location.topLeftFinder.x, location.topLeftFinder.y, moduleSize, context);
        markFinderPattern(location.topRightFinder.x, location.topRightFinder.y, moduleSize, context);
        markFinderPattern(location.bottomLeftFinder.x, location.bottomLeftFinder.y, moduleSize, context);
}
      
if (self.Uint8Array) {
       if (!Uint8Array.from) {
          Uint8Array.from = function (array) {
        ...
        if (!Uint8Array.prototype.forEach) {
          ...
          Uint8Array.prototype.forEach = function (callback, context) {
...
(function (global, factory) {
  ...
  var GenericGFPoly = /*#__PURE__*/ (function () {
    ...
    GenericGFPoly.prototype.addOrSubtract = function (other) {
      ...
      var sumDiff = new Uint8Array(largerCoefficients.length);
  ...
  var Matrix = /*#__PURE__*/ (function () {
    function Matrix(width, height, buffer) {
      ...
      this.data = buffer || new Uint8Array(bufferSize);
    }
  ...
  function binarize(data, width, height, returnInverted, greyscaleWeights, canOverwriteImage) {
    ...
    if (canOverwriteImage) {
      greyscaleBuffer = new Uint8Array(data.buffer, bufferOffset, pixelCount);
    ...
    if (canOverwriteImage) {
      blackPointsBuffer = new Uint8Array(data.buffer, bufferOffset, blackPointsCount);
    ...
    var binarized;
    if (canOverwriteImage) {
      var binarizedBuffer = new Uint8Array(data.buffer, bufferOffset, pixelCount);
      bufferOffset += pixelCount;
    ...
    if (returnInverted) {
      if (canOverwriteImage) {
        var invertedBuffer = new Uint8Array(data.buffer, bufferOffset, pixelCount);
